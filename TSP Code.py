...
if __name__ == "__main__":
    ...
    for i in range(1, len(sys.argv), 2):
        ...
        # Alternative names for arguments
        if arg == "--gs":
            arg = "--graph_size"
        elif arg == "--f":
            arg = "--filename"
            ...
            arg = "--algorithm"
            # Alternative names for algorithms
            if value == "nn":
    ...
    graph_size = int(args["--graph_size"]) if "--graph_size" in args and args["--graph_size"] else 100
    filename = args["--filename"] if "--filename" in args and args["--filename"] else f"{graph_size}.graph"
    algorithm = args["--algorithm"] if "--algorithm" in args and args["--algorithm"] else "heuristic"
